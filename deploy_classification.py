...
import torch
import torchvision
import UNet.unet.unet_model as network
# import segnet1 as network
# import resnet.lib.model.faster_rcnn.resnet as network
...
with autotvm.tophub.context(target):
    ...
    #---------------- load resnet
    # model_name = "resnet18"
    # model_new = getattr(torchvision.models, model_name)(pretrained=True)
    # model_new = model_new.eval()

    # ---------------load other model
    #from resnet import resnet18
    #net = resnet18()
    checkpoint = torch.load('/home/amax/zmb/segnet_tvm/UNet/checkpoints/checkpoint_epoch3.pth') #,map_location="cpu")

    # import segnet1 as network
    net = network.UNet(3,2,bilinear=True)
    # # checkpoint = torch.load('/home/amax/zmb/segnet_tvm/seg_10.pth')
    ...
    # model_new(input_data)
    scripted_model = torch.jit.trace(model_new, input_data).eval()
