...
#    module="darknet",
#)
weights_path = "/mnt/HDD/soc_lab_KYB/TVM/tvm-v0.17.0/vta/tutorials/frontend/yolov3-tiny.weights"
...
#pack_dict = {
#    "yolov3-tiny": ["nn.max_pool2d", "cast", 6, 4],
#}
#----------------------------------------
...
#
    with tvm.transform.PassContext(opt_level=3):
        lib = relay.build(mod, target=target, target_host=tvm.target.Target("llvm"),params=params)
